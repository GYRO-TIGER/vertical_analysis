...
if __name__ == '__main__':
    ...
    command = [
        'C:\\ffmpeg\\bin\\ffmpeg.exe', '-y', '-f', 'rawvideo', '-vcodec', 'rawvideo',
    ...
    audio_extract_command = [
        'C:\\ffmpeg\\bin\\ffmpeg.exe', '-y', '-i', input_video, '-vn', '-acodec', 'copy', temp_audio_output
    ]
    try:
    ...
    step_start_time = time.time()
    merge_command = [
        'C:\\ffmpeg\\bin\\ffmpeg.exe', '-y', '-i', temp_video_output, '-i', temp_audio_output,
